...
private val HoopButtonShape = androidx.compose.foundation.shape.RoundedCornerShape(HoopRadius.Sm)
...
fun HoopSecondaryButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            1.5.dp,
            if (enabled) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.outlineVariant
        ),
        content = {
            HoopButtonContent(text = text, icon = icon)
        }
